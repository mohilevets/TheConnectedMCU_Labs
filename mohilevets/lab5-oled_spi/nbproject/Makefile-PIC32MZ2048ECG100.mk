...
${OBJECTDIR}/src/OLED/FillPat.o: src/OLED/FillPat.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/FillPat.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/FillPat.o.d" -o ${OBJECTDIR}/src/OLED/FillPat.o src/OLED/FillPat.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/OLED/OLED.o: src/OLED/OLED.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/OLED.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/OLED.o.d" -o ${OBJECTDIR}/src/OLED/OLED.o src/OLED/OLED.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/OLED/OledChar.o: src/OLED/OledChar.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/OledChar.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/OledChar.o.d" -o ${OBJECTDIR}/src/OLED/OledChar.o src/OLED/OledChar.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/OLED/OledGrph.o: src/OLED/OledGrph.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/OledGrph.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/OledGrph.o.d" -o ${OBJECTDIR}/src/OLED/OledGrph.o src/OLED/OledGrph.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/OLED/SPI.o: src/OLED/SPI.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/SPI.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/SPI.o.d" -o ${OBJECTDIR}/src/OLED/SPI.o src/OLED/SPI.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/OLED/OLED.o: src/OLED/OLED.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/OLED/OLED.o.d 
	@${RM} ${OBJECTDIR}/src/OLED/OLED.o 
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/OLED.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/OLED.o.d" -o ${OBJECTDIR}/src/OLED/OLED.o src/OLED/OLED.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/OLED/SPI.o: src/OLED/SPI.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/OLED/SPI.o.d 
	@${RM} ${OBJECTDIR}/src/OLED/SPI.o 
	@${FIXDEPS} "${OBJECTDIR}/src/OLED/SPI.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/OLED/SPI.o.d" -o ${OBJECTDIR}/src/OLED/SPI.o src/OLED/SPI.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/main.o: src/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/main.o.d 
	@${RM} ${OBJECTDIR}/src/main.o 
	@${FIXDEPS} "${OBJECTDIR}/src/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/main.o.d" -o ${OBJECTDIR}/src/main.o src/main.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/src/user.o: src/user.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/user.o.d 
	@${RM} ${OBJECTDIR}/src/user.o 
	@${FIXDEPS} "${OBJECTDIR}/src/user.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -MMD -MF "${OBJECTDIR}/src/user.o.d" -o ${OBJECTDIR}/src/user.o src/user.c   -save-temps=obj -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
